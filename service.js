 ...
 */
window.service.captureMouse = function (element) {
 ...
 */
window.service.captureTouch = function (element) {
 ...
 */
window.service.parseColor = function (color, toNumber) {
  if (toNumber === true) {
 ...
 * @return {string}
 */
window.service.colorToRGB = function (color, alpha) {
 ...
 * @return {boolean}
 */
window.service.containsPoint = function (rect, x, y) {
  return !(x < rect.x ||
           x > rect.x + rect.width ||
           y < rect.y ||
...
window.service.containsPointa = function (rect, x, y) {
	//alert(!(x < rect.x ||
           //x > rect.x + rect.width ||
           //y < rect.y ||
           //y > rect.y + rect.height));
 ...
 * @return {boolean}
 */
window.service.intersects = function (rectA, rectB) {
